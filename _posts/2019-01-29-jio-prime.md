---
layout: post
title:  Analysis of a Fraud Android App
date:   2019-01-29 13:30:35 +0300
image:  '/assets/img/fj00.jpeg'
tags:   [security infosec android]
---
...
![](/assets/img/fj01.png)![]({{site.baseurl}}/assets/img/fj02.png)![]({{site.baseurl}}/assets/img/fj03.png)
...
![]({{site.baseurl}}/assets/img/fj04.png)![]({{site.baseurl}}/assets/img/fj05.png)![]({{site.baseurl}}/assets/img/fj06.png)
...
![]({{site.baseurl}}/assets/img/fj07.png)![]({{site.baseurl}}/assets/img/fj08.png)

Later I uploaded the APK to [VirusTotal](https://virustotal.com) for their analysis. One thing that attracted my attention was a Service named “er.upgrad.jio.jioupgrader.Coinhive“. While Coinhive (link to KrebsonSecurity article) is a cryptocurrency mining service, this app could be a miner in the name of Jio. Eat the process of user device, earn money for the APK owner.

Fourteen (14) Engines at VirusTotal also marked this app as malicious, screenshot here:

![]({{site.baseurl}}/assets/img/fj09.png)
...
VirusTotal report available here: [Report](https://www.virustotal.com/#/file/7f4cea3b6bceb4aebb45a8f1c6e528f90eec1a87009f18d93de51b32fc85034c/detection)
